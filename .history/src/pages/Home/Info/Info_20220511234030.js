...
const Info = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-5 mx-4' >
            ...
            <InfoCard img={clock} title='Opening Hours' para='Here are Open at 9.00 am and close 10.00 pm' ></InfoCard>
            <InfoCard img={map} title='Opening Hours'para='Here are Open at 9.00 am and close 10.00 pm' ></InfoCard>
            <InfoCard img={phone} title='Contact Now'para='Here are Open at 9.00 am and close 10.00 pm' ></InfoCard>
            <div className="card text-base-100 lg:card-side bg-gradient-to-r from-secondary to-primary p-5 shadow-xl">
