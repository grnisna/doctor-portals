        ...
        <div className="card lg:card-side bg-base-100 my-10 p-4">
            ...
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        <img className='lg:ml-40' src={appointment} alt="traatement" />
                    </div>

                    <div className='lg:ml-48' >
                        <h1 className="lg:text-6xl sm:text-4xl md:text-6xl font-bold">Exceptional Dental Care, on Your Terms </h1>
